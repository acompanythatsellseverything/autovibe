  ...
  return (
    <section className="relative py-16">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="mb-12 text-center text-[40px] font-medium leading-[100%] tracking-[0%] text-[#DFDBC8]">
          Cómo funciona
        </h2>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, index) => (
            <div key={index} className="text-left">
              <h3 className="mb-2 text-[25px] font-medium leading-[100%] tracking-[0%] text-[#DFDBC8]">
                {step.number}. {step.title}
              </h3>
              <p className="text-[18px] font-normal leading-[100%] tracking-[0%] text-[#DFDBC8]">
                {step.description}
              </p>
            </div>
          ))}
