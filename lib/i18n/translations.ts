  ...
  es: {
    ...
    pages: {
      suscripcion: {
        ...
        permanenciaLargaDesc: '1-36 meses',
        permanenciaCorta: 'Permanencia corta',
        permanenciaCortaDesc: '1-31 días',
      ...
      empresas: {
        ...
        subtitle: 'Solución de movilidad empresarial con contratos de 1 a 31 días. Sin ataduras largas, adaptado a tus necesidades.',
        permanenciaLarga: 'Permanencia larga',
        permanenciaLargaDesc: '1-36 meses',
        permanenciaCorta: 'Permanencia corta',
        permanenciaCortaDesc: '1-31 días',
  ...
  en: {
    ...
    pages: {
      suscripcion: {
        ...
        permanenciaLargaDesc: '1-36 months',
        permanenciaCorta: 'Short-term rental',
        permanenciaCortaDesc: '1-31 days',
      ...
      empresas: {
        ...
        subtitle: 'Business mobility solution with contracts from 1 to 31 days. No long-term commitments, adapted to your needs.',
        permanenciaLarga: 'Long-term rental',
        permanenciaLargaDesc: '1-36 months',
        permanenciaCorta: 'Short-term rental',
        permanenciaCortaDesc: '1-31 days',
    ...
    carPage: {
      ...
      dia: 'day',
      dias: 'days',
      diasDisponibles: 'days available',
  ...
  uk: {
    ...
    pages: {
      suscripcion: {
        ...
        permanenciaLargaDesc: '1-36 місяців',
        permanenciaCorta: 'Короткострокова оренда',
        permanenciaCortaDesc: '1-31 днів',
      ...
      empresas: {
        ...
        subtitle: 'Рішення для бізнес-мобільності з контрактами від 1 до 31 днів. Без довгострокових зобов\'язань, адаптовано до твоїх потреб.',
        permanenciaLarga: 'Довгострокова оренда',
        permanenciaLargaDesc: '1-36 місяців',
        permanenciaCorta: 'Короткострокова оренда',
        permanenciaCortaDesc: '1-31 днів',
    ...
    carPage: {
      ...
      dia: 'день',
      dias: 'днів',
      diasDisponibles: 'днів доступно',
      precioDia: 'Ціна на день',
      // Compra (purchase)
  ...
  ru: {
    ...
    pages: {
      suscripcion: {
        ...
        permanenciaLargaDesc: '1-36 месяцев',
        permanenciaCorta: 'Краткосрочная аренда',
        permanenciaCortaDesc: '1-31 дней',
      ...
      empresas: {
        ...
        subtitle: 'Решение для бизнес-мобильности с контрактами от 1 до 31 дней. Без долгосрочных обязательств, адаптировано к твоим потребностям.',
        permanenciaLarga: 'Долгосрочная аренда',
        permanenciaLargaDesc: '1-36 месяцев',
        permanenciaCorta: 'Краткосрочная аренда',
        permanenciaCortaDesc: '1-31 дней',
    ...
    carPage: {
      ...
      dia: 'день',
      dias: 'дней',
      diasDisponibles: 'дней доступно',
      precioDia: 'Цена в день',
      // Compra (purchase)
