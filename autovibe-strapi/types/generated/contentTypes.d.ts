...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image_compra: Schema.Attribute.Media<'images'>;
    image_empresas: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::car.car'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Enumeration<
      ['Valencia', 'Barcelona', 'Madrid', 'Marbella']
    > &
      Schema.Attribute.Required;
    mileageOptions: Schema.Attribute.JSON;
